...
include "connect.php"; 
$sid=$_GET['id'];
$result3 = mysql_query("SELECT * FROM student where Student_ID='$id'");
  ...
  <!-- HERO -->
    <div class="span10 offset2 "  style="margin-top:-200px">
      <div class="hero-unit" style="background-image:url(assets/img/cruh.jpg)">
        <div class="row">
          <div class="span4">
		<?php echo "<img src="."\"".$pic."\""."\"class=\"img-rounded pull-left\" style=\"box-shadow:10px 10px 5px #888 ;margin-left:-10px ; margin-top:-10px ; max-height:100px ; max-width:100px\"   data-src=\"holder.js/140x140\">";?>
		  
            
            <h3 style="text-align:center; text-shadow: 2px 2px 5px #888;"><?php echo $uname ?></h3>
            <h5 style=" text-shadow: 1px 1px 5px #888;">&nbsp&nbsp(Student)</h5> 
          </div>
          <div class="span3 mycontent-right">
                <dl class="dl-horizontal" style="margin-left:-30%">
				  ...
				  <dt>Package</dt>
                  <dd><?php
					$pack=mysql_query("Select * from package natural join package_having_subject where Package_ID='$packid'");
					echo $packid. " costing ".$pack['Price']. "having subjects"
					$sub=mysql_query("select Subject_Name from package_having_subject natural join subject where Package_ID='$packid'");
					while($sub=mysql_fetch_assoc($pack))
					{
...
<!-- SIDE-NAVBAR RIGHT -->
    <div class="span4 " style="margin-top:-220px; padding:20px">
          ...
          <li class="nav-header" style="font-size:12px">Student's Courses</li>
		  ...
		  <?php 
			...
			while($result=mysql_fetch_assoc($sql))
			{
			 ...
			 echo "<li>". $result['Subject_Name']. "</li>";
		 
            }
			?>
			<!-- ***add link to student's questions here
			
          <li class="nav-header" style="font-size:12px">Student's Questions</li>
