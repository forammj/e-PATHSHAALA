...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Textbook &middot; e-PATHSHAALA</title>
  ...
  <div class="container marketing">
    <div class="row">
      <div class="span3" style="font-family: Century Gothic" >
        ...
        <h3 style="margin-top:-315px; margin-left:-70px; position:absolute; color:#FFFFFF; text-shadow:2px 2px 10px black;">Revision Notes & Summary</h3>
        <h3 style="margin-top:-290px; margin-left:-70px; position:absolute; color:#FFFFFF; text-shadow:2px 2px 10px black;">
		<?php 
		$brd=$_SESSION['board'];
		$sql=mysql_query("select * from board where BOARD_ID='$brd' ");
		$boardname=mysql_fetch_assoc($sql);
...
?>
  ...
  <div class="span8 "  style="margin-top:-200px">
    <div class="hero-unit">
      <h2 style="margin-top:-5%">Select a Chapter to view the Revision Notes: </h2> 
      <div class="row-fluid">
        <table class="table table-hover table-condensed"  style="font-size:15px">
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 1 : Chapter one</a></td>
            <td><span class="badge badge-warning">Free!</span></td>
          </tr> 
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 2 : Chapter two</a></td>
            <td><span class="badge badge-warning">Free!</span></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 3 : Chapter three</a></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td> <a href="#">Ch 4 : Chapter four</a></td>
          </tr> 
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 5 : Chapter five</a></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 6 : Chapter six</a></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td> <a href="#">Ch 7 : Chapter seven</a></td>
          </tr> 
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 8 : Chapter two</a></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 9 : Chapter three</a></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td> <a href="#">Ch 10 : Chapter one</a></td>
          </tr> 
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 11 : Chapter two</a></td>
          </tr>
          <tr>
            <td><i class="icon-book"></i></td>
            <td><a href="#">Ch 12 : Chapter three</a></td>
          </tr>
        </table>
      </div>
    </div> <!--hero unit-->
