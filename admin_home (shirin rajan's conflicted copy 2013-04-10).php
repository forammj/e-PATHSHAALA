      ...
      <div class="row span5" style="margin-top:-20%">
        <div class="well" style="text-align:center">
          <h4>&middot; Go To &middot; </h4>
           <form autocomplete="off" action="" method="post" name="form" class="form-horizontal" />
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <option value="ICSE">Q&A</option>
                  <option value="GBSE">Study Page</option>
                  </select>           
                </div>
              </div>
              <hr>
            ...
            <div class="tabbable" style=" font-size:13px">
              ...
              <!--pane1 Tab-->
                <div id="pane1" class="tab-pane active" style="max-height:270px">
				  ...
				  <!--clicking on link we can see them...-->
					<ol>
					
					<?php
									                    					  
					  $q= "SELECT * fROM quiz ORDER BY Timestamp DESC";
					  $xxx=mysql_query($q);
					  while( $row=mysql_fetch_assoc($xxx))
					  {
					  $subjid=$row['Subject ID'];
					  $facid=$row['Faculty ID'];
					  $class=$row['class'];
					  $boardid=$row['Board ID'];
					  					  
					  $subj="select Subject_name from subject where Subject ID='$subjid'";
					  $faculty="select faculty name from faculty where Faculty ID='$facid'";
					  $board="select Board_Name from Board where Board_ID='$boardid'";
					   ...
					   echo "<li><a href=\"quiz_display.php\">".$row['quiz name']."</a><span class=\"pull-right\">
						 <a href=\"approval.php\"> <i class=\"icon-ok\"></i> </a>
							<a href=\"disapproval.php\"><i class=\"icon-remove\"></i></a></span>
							<br><span style=\"font-size:12px\">" .$subj. " class " . $row['class']. " board " . $board. "
							uploaded by " .$faculty. "</a> on " .$row['Timestamp']. "</span></li>";
							//faculty link to be inserted
					}
                ...
                <div id="pane2" class="tab-pane" style="max-height:270px;">
                  <h5>Study resources to be approved</h5>
                   <ol>
                      <li><a href="#">Ch-9 Algebra Textbook Soln.</a><span class="pull-right"><a href="#"> <i class="icon-ok"></i> </a><a href="#">&nbsp;<i class="icon-remove"></i></a></span><br><span style="font-size:12px">Maths (class 7th, CBSE) uploaded by <a href="#">Expert</a> on date</span></li>
                      <li><a href="#">Ch-3 Electricity Revision Notes</a><span class="pull-right"><a href="#"> <i class="icon-ok"></i> </a><a href="#">&nbsp;<i class="icon-remove"></i></a></span><br><span style="font-size:12px">Science (class 8th, CBSE) uploaded by <a href="#">Expert</a> on date</span></li>
                     <li><a href="#">Ch-3 Electricity Textbook Soln.</a><span class="pull-right"><a href="#"> <i class="icon-ok"></i> </a><a href="#">&nbsp;<i class="icon-remove"></i></a></span><br><span style="font-size:12px">Science (class 8th, CBSE) uploaded by <a href="#">Expert</a> on date</span></li>
                    </ol>
                </div>
