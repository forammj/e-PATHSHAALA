  ...
  <div class="container marketing">
    <div class="row">
      <div class="span3" style="font-family: Century Gothic" >
        ...
        <h3 style="margin-top:-315px; margin-left:-70px; position:absolute; color:#FFFFFF; text-shadow:2px 2px 10px black;">Textbook Solutions</h3>
...
?>
  ...
  <div class="span8 "  style="margin-top:-200px">
    <div class="hero-unit">
      <h2 style="margin-top:-5%">Select a Chapter to view the solutions: </h2> 
      <div class="row-fluid">
  ...
  <?php
		include "connect.php";
			...
			$sql=mysql_query("select * from study_material where Board_ID='$board' and Subject_ID='$subject'");
		...
		//	 echo "<li><a href=\"Subject.php?link=".$result['Subject_Name']."&link2=".$result2['Quiz_ID']." \">". $result2['Quiz_Name']. "</a></li>";
		 echo"
          <tr>
            ...
            <td><a href=\"pdf_disp.php?link=".$_GET['link']."&link1=".$result['Material_link']."\">". $result['Material_name']. "</a></td>
